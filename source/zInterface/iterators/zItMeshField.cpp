...
namespace zSpace
{
	...
	ZSPACE_INLINE void zItMeshScalarField::getNeighbour_Ring(int numRings, vector<zItMeshScalarField> &ringNeighbours)
	{
	...
	ZSPACE_INLINE void zItMeshScalarField::getNeighbour_Ring(int numRings, vector<int> &ringNeighbours)
	{
		ringNeighbours.clear();
	...
	ZSPACE_INLINE void zItMeshScalarField::getNeighbourPosition_Ring(int numRings, vector<zVector> &ringNeighbours)
	{
		ringNeighbours.clear();

		vector<zItMeshScalarField> rNeighbour;
	...
	ZSPACE_INLINE void zItMeshScalarField::getNeighbour_Adjacents(vector<zItMeshScalarField> &adjacentNeighbours)
	{
	...
	ZSPACE_INLINE void zItMeshScalarField::getNeighbour_Adjacents(vector<int> &adjacentNeighbours)
	{
		adjacentNeighbours.clear();
	...
	ZSPACE_INLINE void zItMeshScalarField::getNeighbourPosition_Adjacents(vector<zVector> &adjacentNeighbours)
	{
		adjacentNeighbours.clear();

		vector<zItMeshScalarField> aNeighbour;
...
namespace zSpace
{
	...
	ZSPACE_INLINE void zItMeshVectorField::getNeighbour_Ring(int numRings, vector<zItMeshVectorField> &ringNeighbours)
	{
		ringNeighbours.clear();
	...
	ZSPACE_INLINE void zItMeshVectorField::getNeighbour_Ring(int numRings, vector<int> &ringNeighbours)
	{
		ringNeighbours.clear();
	...
	ZSPACE_INLINE void zItMeshVectorField:: getNeighbourPosition_Ring(int numRings, vector<zVector> &ringNeighbours)
	{
		ringNeighbours.clear();

		vector<zItMeshVectorField> rNeighbour;
		getNeighbour_Ring(numRings, rNeighbour);
	...
	ZSPACE_INLINE void zItMeshVectorField::getNeighbour_Adjacents(vector<zItMeshVectorField> &adjacentNeighbours)
	{
		adjacentNeighbours.clear();
	...
	ZSPACE_INLINE void zItMeshVectorField::getNeighbour_Adjacents(vector<int> &adjacentNeighbours)
	{
		adjacentNeighbours.clear();
	...
	ZSPACE_INLINE void zItMeshVectorField::getNeighbourPosition_Adjacents(vector<zVector> &adjacentNeighbours)
	{
		adjacentNeighbours.clear();

		vector<zItMeshVectorField> aNeighbour;
		getNeighbour_Adjacents(aNeighbour);
