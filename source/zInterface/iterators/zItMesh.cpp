...
namespace zSpace
{
	...
	ZSPACE_INLINE void zItMeshVertex::getConnectedHalfEdges(vector<zItMeshHalfEdge>& halfedges)
	{
	...
	ZSPACE_INLINE void zItMeshVertex::getConnectedHalfEdges(vector<int>& halfedgeIndicies)
	{
		if (!this->iter->getHalfEdge()) return;
	...
	ZSPACE_INLINE void zItMeshVertex::getConnectedEdges(vector<zItMeshEdge>& edges)
	{
	...
	ZSPACE_INLINE void zItMeshVertex::getConnectedEdges(vector<int>& edgeIndicies)
	{
		vector<zItMeshHalfEdge> cHEdges;
		getConnectedHalfEdges(cHEdges);
	...
	ZSPACE_INLINE void zItMeshVertex::getConnectedVertices(vector<zItMeshVertex>& verticies)
	{
		vector<zItMeshHalfEdge> cHEdges;
		getConnectedHalfEdges(cHEdges);
	...
	ZSPACE_INLINE void zItMeshVertex::getConnectedVertices(vector<int>& vertexIndicies)
	{
		vector<zItMeshHalfEdge> cHEdges;
		getConnectedHalfEdges(cHEdges);
	...
	ZSPACE_INLINE void zItMeshVertex::getConnectedFaces(vector<zItMeshFace>& faces)
	{
		vector<zItMeshHalfEdge> cHEdges;
		getConnectedHalfEdges(cHEdges);
	...
	ZSPACE_INLINE void zItMeshVertex::getConnectedFaces(vector<int>& faceIndicies)
	{
		vector<zItMeshHalfEdge> cHEdges;
		getConnectedHalfEdges(cHEdges);
...
namespace zSpace
{
	...
	ZSPACE_INLINE void zItMeshEdge::getVertices(vector<zItMeshVertex> &verticies)
	{
		verticies.push_back(getHalfEdge(0).getVertex());
		verticies.push_back(getHalfEdge(1).getVertex());
	}

	ZSPACE_INLINE void zItMeshEdge::getVertices(vector<int> &vertexIndicies)
	{
	...
	ZSPACE_INLINE void zItMeshEdge::getFaces(vector<zItMeshFace> &faces)
	{
		faces.clear();
	...
	ZSPACE_INLINE void zItMeshEdge::getFaces(vector<int> &faceIndicies)
	{
		faceIndicies.clear();
...
namespace zSpace
{
	...
	ZSPACE_INLINE void zItMeshFace::getHalfEdges(vector<zItMeshHalfEdge> &halfedges)
	{
		halfedges.clear();
	...
	ZSPACE_INLINE void zItMeshFace::getHalfEdges(vector<int> &halfedgeIndicies)
	{
	...
	ZSPACE_INLINE void zItMeshFace::getVertices(vector<zItMeshVertex> &verticies)
	{
	...
	ZSPACE_INLINE void zItMeshFace::getVertices(vector<int> &vertexIndicies)
	{
		vector<zItMeshHalfEdge> faceHEdges;
		getHalfEdges(faceHEdges);
	...
	ZSPACE_INLINE void zItMeshFace::getConnectedFaces(vector<zItMeshFace>& faces)
	{
		vector<zItMeshHalfEdge> cHEdges;
	...
	ZSPACE_INLINE void zItMeshFace::getConnectedFaces(vector<int>& faceIndicies)
	{
		vector<zItMeshHalfEdge> cHEdges;
		getHalfEdges(cHEdges);
	...
	ZSPACE_INLINE void zItMeshFace::getTriangles(int &numTris, vector<int> &tris)
	{
		double angle_Max = 90;
	...
	ZSPACE_INLINE double zItMeshFace::getVolume(vector<int> &faceTris, zVector &fCenter, bool absoluteVolume)
	{
...
namespace zSpace
{
	...
	ZSPACE_INLINE void zItMeshHalfEdge::getVertices(vector<zItMeshVertex> &verticies)
	{
		verticies.push_back(getVertex());
		verticies.push_back(getSym().getVertex());
	}

	ZSPACE_INLINE void zItMeshHalfEdge::getVertices(vector<int> &vertexIndicies)
	{
	...
	ZSPACE_INLINE void zItMeshHalfEdge::getConnectedHalfEdges(vector<zItMeshHalfEdge>& edgeIndicies)
	{
	...
	ZSPACE_INLINE void zItMeshHalfEdge::getConnectedHalfEdges(vector<int>& edgeIndicies)
	{
		zItMeshVertex v1 = getVertex();
	...
	ZSPACE_INLINE void zItMeshHalfEdge::getFaces(vector<zItMeshFace> &faceIndicies)
	{
		this->getEdge().getFaces(faceIndicies);
	}

	ZSPACE_INLINE void zItMeshHalfEdge::getFaces(vector<int> &faceIndicies)
	{
		this->getEdge().getFaces(faceIndicies);
	}
