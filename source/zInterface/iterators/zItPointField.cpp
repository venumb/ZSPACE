...
namespace zSpace
{
	...
	ZSPACE_INLINE void zItPointScalarField::getNeighbour_Ring(int numRings, vector<zItPointScalarField> &ringNeighbours)
	{
	...
	ZSPACE_INLINE void zItPointScalarField::getNeighbour_Ring(int numRings, vector<int> &ringNeighbours)
	{
		ringNeighbours.clear();

		vector<zItPointScalarField> rNeighbours;
	...
	ZSPACE_INLINE void zItPointScalarField::getNeighbourPosition_Ring(int numRings, vector<zVector> &ringNeighbours)
	{
		ringNeighbours.clear();

		vector<zItPointScalarField> rNeighbour;
	...
	ZSPACE_INLINE void zItPointScalarField::getNeighbour_Adjacents(vector<zItPointScalarField> &adjacentNeighbours)
	{
	...
	ZSPACE_INLINE void zItPointScalarField::getNeighbour_Adjacents(vector<int> &adjacentNeighbours)
	{
		adjacentNeighbours.clear();

		vector<zItPointScalarField> aNeighbours;
		this->getNeighbour_Adjacents(aNeighbours);

		for (auto n : aNeighbours) adjacentNeighbours.push_back(n.getId());
	}

	ZSPACE_INLINE void zItPointScalarField::getNeighbourPosition_Adjacents(vector<zVector> &adjacentNeighbours)
	{
		adjacentNeighbours.clear();

		vector<zItPointScalarField> aNeighbour;
...
namespace zSpace
{
	...
	ZSPACE_INLINE void zItPointVectorField::getNeighbour_Ring(int numRings, vector<zItPointVectorField> &ringNeighbours)
	{
		ringNeighbours.clear();
	...
	ZSPACE_INLINE void zItPointVectorField::getNeighbour_Ring(int numRings, vector<int> &ringNeighbours)
	{
		ringNeighbours.clear();

		vector<zItPointVectorField> rNeighbours;
		this->getNeighbour_Ring(numRings, rNeighbours);
	...
	ZSPACE_INLINE void zItPointVectorField::getNeighbourPosition_Ring(int numRings, vector<zVector> &ringNeighbours)
	{
		ringNeighbours.clear();

		vector<zItPointVectorField> rNeighbour;
		getNeighbour_Ring(numRings, rNeighbour);
	...
	ZSPACE_INLINE void zItPointVectorField::getNeighbour_Adjacents(vector<zItPointVectorField> &adjacentNeighbours)
	{
		adjacentNeighbours.clear();
	...
	ZSPACE_INLINE void zItPointVectorField::getNeighbour_Adjacents(vector<int> &adjacentNeighbours)
	{
		adjacentNeighbours.clear();

		vector<zItPointVectorField> aNeighbours;
		this->getNeighbour_Adjacents(aNeighbours);

		for (auto n : aNeighbours) adjacentNeighbours.push_back(n.getId());
	}

	ZSPACE_INLINE void zItPointVectorField::getNeighbourPosition_Adjacents(vector<zVector> &adjacentNeighbours)
	{
		adjacentNeighbours.clear();

		vector<zItPointVectorField> aNeighbour;
		getNeighbour_Adjacents(aNeighbour);
