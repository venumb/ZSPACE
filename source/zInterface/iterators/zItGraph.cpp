...
namespace zSpace
{
	...
	ZSPACE_INLINE void zItGraphVertex::getConnectedHalfEdges(vector<zItGraphHalfEdge>& halfedges)
	{
	...
	ZSPACE_INLINE void zItGraphVertex::getConnectedHalfEdges(vector<int>& halfedgeIndicies)
	{
		if (!getHalfEdge().isActive()) return;
	...
	ZSPACE_INLINE void zItGraphVertex::getConnectedEdges(vector<zItGraphEdge>& edges)
	{
	...
	ZSPACE_INLINE void zItGraphVertex::getConnectedEdges(vector<int>& edgeIndicies)
	{
		vector<zItGraphHalfEdge> cHEdges;
		getConnectedHalfEdges(cHEdges);
	...
	ZSPACE_INLINE void zItGraphVertex::getConnectedVertices(vector<zItGraphVertex>& verticies)
	{
		vector<zItGraphHalfEdge> cHEdges;
		getConnectedHalfEdges(cHEdges);
	...
	ZSPACE_INLINE void zItGraphVertex::getConnectedVertices(vector<int>& vertexIndicies)
	{
		vector<zItGraphHalfEdge> cHEdges;
		getConnectedHalfEdges(cHEdges);
	...
	int zItGraphVertex::getId()
	{
		return iter->getId();
	}

	zItGraphHalfEdge zItGraphVertex::getHalfEdge()
	{
	...
	ZSPACE_INLINE zVector zItGraphVertex::getPosition()
	{
		return graphObj->graph.vertexPositions[getId()];
	}

	ZSPACE_INLINE zVector* zItGraphVertex::getRawPosition()
	{
		return &graphObj->graph.vertexPositions[getId()];
	}
...
namespace zSpace
{
	...
	ZSPACE_INLINE void zItGraphEdge::getVertices(vector<zItGraphVertex> &verticies)
	{
		verticies.push_back(getHalfEdge(0).getVertex());
		verticies.push_back(getHalfEdge(1).getVertex());
	}

	ZSPACE_INLINE void zItGraphEdge::getVertices(vector<int> &vertexIndicies)
	{
...
namespace zSpace
{
	...
	ZSPACE_INLINE void zItGraphHalfEdge::getVertices(vector<zItGraphVertex> &verticies)
	{
		verticies.push_back(getVertex());
		verticies.push_back(getSym().getVertex());
	}

	ZSPACE_INLINE void zItGraphHalfEdge::getVertices(vector<int> &vertexIndicies)
	{
	...
	ZSPACE_INLINE void zItGraphHalfEdge::getConnectedHalfEdges(vector<zItGraphHalfEdge>& edgeIndicies)
	{
	...
	ZSPACE_INLINE void zItGraphHalfEdge::getConnectedHalfEdges(vector<int>& edgeIndicies)
	{
		zItGraphVertex v1 = getVertex();
