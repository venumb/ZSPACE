...
namespace zSpace
{
	...
	ZSPACE_INLINE zVector zItPointCloudVertex::getPosition()
	{
		return pointsObj->pCloud.vertexPositions[getId()];
	}

	ZSPACE_INLINE zVector* zItPointCloudVertex::getRawPosition()
	{
		return &pointsObj->pCloud.vertexPositions[getId()];
	}
	...
	ZSPACE_INLINE void zItPointCloudVertex::setPosition(zVector &pos)
	{
