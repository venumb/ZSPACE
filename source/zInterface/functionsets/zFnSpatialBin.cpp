...
namespace zSpace
{
	...
	ZSPACE_INLINE void zFnSpatialBin::create(const zVector &_minBB, const zVector &_maxBB , int _res )
	{
	...
	ZSPACE_INLINE void zFnSpatialBin::getNeighbourhoodRing(int index, int numRings, vector<int> &ringNeighbours)
	{
		ringNeighbours.clear();
	...
	ZSPACE_INLINE void zFnSpatialBin::getNeighbourAdjacents(int index, vector<int> &adjacentNeighbours)
	{
		adjacentNeighbours.clear();
	...
	ZSPACE_INLINE bool zFnSpatialBin::getIndex(zVector &pos, int &index)
	{
	...
	ZSPACE_INLINE bool zFnSpatialBin::getIndices(zVector &pos, int &index_X, int &index_Y, int &index_Z)
	{
	...
	ZSPACE_INLINE void zFnSpatialBin::partitionToBin(zVector &inPos, int pointId, int objectId)
	{
