...
namespace zSpace
{
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::create(zVector _minBB, zVector _maxBB, int _n_X, int _n_Y, int _NR, bool _setValuesperVertex, bool _triMesh)
	{
		setValuesperVertex = _setValuesperVertex;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zVector>::create(zVector _minBB, zVector _maxBB, int _n_X, int _n_Y, int _NR, bool _setValuesperVertex, bool _triMesh)
	{
		setValuesperVertex = _setValuesperVertex;
		if (!_setValuesperVertex) _triMesh = false;
		triMesh = _triMesh;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::create(double _unit_X, double _unit_Y, int _n_X, int _n_Y, zVector _minBB, int _NR, bool _setValuesperVertex, bool _triMesh)
	{
		setValuesperVertex = _setValuesperVertex;
		if (!_setValuesperVertex) _triMesh = false;
		triMesh = _triMesh;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zVector>::create(double _unit_X, double _unit_Y, int _n_X, int _n_Y, zVector _minBB, int _NR, bool _setValuesperVertex, bool _triMesh)
	{
		setValuesperVertex = _setValuesperVertex;
		if (!_setValuesperVertex) _triMesh = false;
		triMesh = _triMesh;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getNeighbour_Contained(zVector &pos, vector<int> &containedNeighbour)
	{
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zVector>::getNeighbour_Contained(zVector &pos, vector<int> &containedNeighbour)
	{
		containedNeighbour.clear();
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getNeighbourPosition_Contained(zVector &pos, vector<zVector> &containedNeighbour)
	{
		containedNeighbour.clear();
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zVector>::getNeighbourPosition_Contained(zVector &pos, vector<zVector> &containedNeighbour)
	{
		containedNeighbour.clear();
	...
	template<typename T>
	ZSPACE_INLINE void zFnMeshField<T>::getBoundingBox(zVector &_minBB, zVector &_maxBB)
	{
	...
	template<typename T>
	ZSPACE_INLINE void zFnMeshField<T>::getPositions(vector<zVector> &positions)
	{
	...
	template<>
	ZSPACE_INLINE bool zFnMeshField<zScalar>::getFieldValue(zVector &samplePos, zFieldValueType type, zScalar& fieldValue)
	{
	...
	template<>
	ZSPACE_INLINE bool zFnMeshField<zVector>::getFieldValue(zVector &samplePos, zFieldValueType type, zVector& fieldValue)
	{
	...
	template<typename T>
	ZSPACE_INLINE void zFnMeshField<T>::setBoundingBox(zVector &_minBB, zVector &_maxBB)
	{
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::setFieldValues(vector<zScalar>& fValues)
	{
	...
	template<typename T>
	ZSPACE_INLINE void zFnMeshField<T>::getFieldValuesAsVertexDistance_IDW(vector<T> &fieldValues, vector<zVector> &inPositions, T value, double influence, double power, bool normalise)
	{
	...
	template<typename T>
	ZSPACE_INLINE void zFnMeshField<T>::getFieldValuesAsVertexDistance_IDW(vector<T> &fieldValues, vector<zVector> &inPositions, vector<T> &values, vector<double>& influences, double power, bool normalise)
	{
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getScalarsAsVertexDistance(vector<zScalar> &scalars, vector<zVector> &inPositions, bool normalise)
	{
		scalars.clear();;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getScalarsAsVertexDistance(vector<zScalar> &scalars, vector<zVector> &inPositions, double a, double b, bool normalise)
	{
		scalars.clear();;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getScalarsAsVertexDistance(vector<zScalar> &scalars, zObjPointCloud &inPointsObj, bool normalise)
	{
		scalars.clear();;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getScalarsAsVertexDistance(vector<zScalar> &scalars, zObjPointCloud &inPointsObj, double a, double b, bool normalise)
	{
		scalars.clear();;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getScalarsAsVertexDistance(vector<zScalar> &scalars, zObjMesh &inMeshObj, double a, double b, bool normalise)
	{
		scalars.clear();
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getScalarsAsVertexDistance(vector<zScalar> &scalars, zObjGraph &inGraphObj, double a, double b, bool normalise)
	{
		scalars.clear();
		zFnGraph inFnGraph(inGraphObj);
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getScalarsAsEdgeDistance(vector<zScalar> &scalars, zObjMesh &inMeshObj, double a, double b, bool normalise)
	{
		scalars.clear();
		zFnMesh inFnMesh(inMeshObj);
	...
	template<>
	ZSPACE_INLINE 	void zFnMeshField<zScalar>::getScalarsAsEdgeDistance(vector<zScalar> &scalars, zObjGraph &inGraphObj, double a, double b, bool normalise)
	{
		scalars.clear();
		zFnGraph inFnGraph(inGraphObj);
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getScalars_Circle(vector<zScalar> &scalars, zVector &cen, float r, double annularVal, bool normalise)
	{
		scalars.clear();
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getScalars_Line(vector<zScalar> &scalars, zVector &v0, zVector &v1, double annularVal, bool normalise )
	{
		scalars.clear();
		scalars.assign(fnMesh.numVertices(), 0.0);
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getScalars_Square(vector<zScalar> &scalars, zVector &dimensions, double annularVal, bool normalise)
	{
		scalars.clear();
		scalars.assign(fnMesh.numVertices(), 0.0);
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getScalars_Trapezoid(vector<zScalar> &scalars, double r1, double r2, double he, double annularVal, bool normalise)
	{
		scalars.clear();
		scalars.assign(fnMesh.numVertices(), 0.0);
	...
	template<typename T>
	ZSPACE_INLINE bool zFnMeshField<T>::checkPositionBounds(zVector &pos, int &index)
	{
		bool out = true;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::normliseValues(vector<zScalar> &fieldValues)
	{
		zDomainDouble d;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::computePositionsInFieldIndex(vector<zVector> &positions, vector<vector<zVector>> &fieldIndexPositions)
	{
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zVector>::computePositionsInFieldIndex(vector<zVector> &positions, vector<vector<zVector>> &fieldIndexPositions)
	{
		for (int i = 0; i < numFieldValues(); i++)
		{
			vector<zVector> temp;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::computePositionIndicesInFieldIndex(vector<zVector> &positions, vector<vector<int>> &fieldIndexPositionIndicies)
	{
		for (int i = 0; i < numFieldValues(); i++)
		{
			vector<int> temp;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zVector>::computePositionIndicesInFieldIndex(vector<zVector> &positions, vector<vector<int>> &fieldIndexPositionIndicies)
	{
		for (int i = 0; i < numFieldValues(); i++)
		{
			vector<int> temp;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::boolean_union(vector<zScalar>& scalars0, vector<zScalar>& scalars1, vector<zScalar>& scalarsResult, bool normalise)
	{
		vector<double> out;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::boolean_subtract(vector<zScalar>& fieldValues_A, vector<zScalar>& fieldValues_B, vector<zScalar>& fieldValues_Result, bool normalise)
	{
		vector<double> out;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::boolean_intersect(vector<zScalar>& fieldValues_A, vector<zScalar>& fieldValues_B, vector<zScalar>& fieldValues_Result, bool normalise)
	{
		vector<double> out;
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::boolean_difference(vector<zScalar>& fieldValues_A, vector<zScalar>& fieldValues_B, vector<zScalar>& fieldValues_Result, bool normalise)
	{
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::boolean_clipwithPlane(vector<zScalar>& scalars, zMatrixd& clipPlane)
	{
		int i = 0;
	...
	template<>
	ZSPACE_INLINE double zFnMeshField<zScalar>::getScalar_Circle(zVector &cen, zVector &p, float r)
	{
		return ((p - cen).length() - r);
	}

	template<>
	ZSPACE_INLINE double zFnMeshField<zScalar>::getScalar_Line(zVector &p, zVector &v0, zVector &v1)
	{
		zVector pa = p - v0;
		zVector ba = v1 - v0;
	...
	template<>
	ZSPACE_INLINE double zFnMeshField<zScalar>::getScalar_Square(zVector &p, zVector &dimensions)
	{
	...
	template<>
	ZSPACE_INLINE double zFnMeshField<zScalar>::getScalar_Trapezoid(zVector &p, double &r1, double &r2, double &he)
	{
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getIsolinePoly(zItMeshFace& f , vector<zVector> &positions, vector<int> &polyConnects, vector<int> &polyCounts, unordered_map <string, int> &positionVertex, double &threshold, bool invertMesh)
	{
	...
	template<>
	ZSPACE_INLINE void zFnMeshField<zScalar>::getIsobandPoly(zItMeshFace& f, vector<zVector> &positions, vector<int> &polyConnects, vector<int> &polyCounts, unordered_map <string, int> &positionVertex, double &thresholdLow, double &thresholdHigh)
	{
		vector<zItMeshVertex> fVerts;
		f.getVertices(fVerts);
