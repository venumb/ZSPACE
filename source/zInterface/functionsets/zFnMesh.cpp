...
namespace zSpace
{
	...
	ZSPACE_INLINE void zFnMesh::create(vector<zVector>(&_positions), vector<int>(&polyCounts), vector<int>(&polyConnects), bool staticMesh)
	{
	...
	ZSPACE_INLINE bool zFnMesh::addVertex(zVector &_pos, bool checkDuplicates, zItMeshVertex &vertex)
	{
		if (checkDuplicates)
		{
			int id;
	...
	ZSPACE_INLINE bool zFnMesh::addPolygon(vector<int> &fVertices, zItMeshFace &face)
	{
	...
	ZSPACE_INLINE bool zFnMesh::addPolygon(vector<zVector> &fVertices, zItMeshFace &face)
	{
		vector<int> fVerts;
	...
	ZSPACE_INLINE bool zFnMesh::vertexExists(zVector pos, zItMeshVertex &outVertex, int precisionfactor)
	{
	...
	ZSPACE_INLINE void zFnMesh::setVertexPositions(vector<zVector>& pos)
	{
	...
	ZSPACE_INLINE void zFnMesh::setVertexColors(vector<zColor>& col, bool setFaceColor)
	{
	...
	ZSPACE_INLINE void zFnMesh::setFaceColors(vector<zColor>& col, bool setVertexColor)
	{
	...
	ZSPACE_INLINE void zFnMesh::setFaceNormals(vector<zVector> &fNormals)
	{
	...
	ZSPACE_INLINE void zFnMesh::setEdgeColors(vector<zColor>& col, bool setVertexColor)
	{
	...
	ZSPACE_INLINE void zFnMesh::setEdgeWeights(vector<double>& wt)
	{
	...
	ZSPACE_INLINE void zFnMesh::getVertexPositions(vector<zVector>& pos)
	{
		pos = meshObj->mesh.vertexPositions;
	}

	ZSPACE_INLINE zVector* zFnMesh::getRawVertexPositions()
	{
	...
	ZSPACE_INLINE void zFnMesh::getVertexNormals(vector<zVector>& norm)
	{
	...
	ZSPACE_INLINE void zFnMesh::getVertexColors(vector<zColor>& col)
	{
	...
	ZSPACE_INLINE void zFnMesh::getEdgeColors(vector<zColor>& col)
	{
	...
	ZSPACE_INLINE void zFnMesh::getFaceNormals(vector<zVector>& norm)
	{
	...
	ZSPACE_INLINE void zFnMesh::getFaceColors(vector<zColor>& col)
	{
	...
	ZSPACE_INLINE zVector zFnMesh::getCenter()
	{
		zVector out;
	...
	ZSPACE_INLINE void zFnMesh::getCenters(zHEData type, vector<zVector> &centers)
	{
		// Mesh Edge 
	...
	ZSPACE_INLINE void zFnMesh::getDualMesh(zObjMesh &dualMeshObj, vector<int> &inEdge_dualEdge, vector<int> &dualEdge_inEdge, bool excludeBoundary, bool keepExistingBoundary, bool rotate90)
	{
	...
	ZSPACE_INLINE void zFnMesh::getDualGraph(zObjGraph &dualGraphObj, vector<int> &inEdge_dualEdge, vector<int> &dualEdge_inEdge, bool excludeBoundary , bool PlanarMesh , bool rotate90)
	{
		vector<zVector> positions;
	...
	ZSPACE_INLINE void zFnMesh::getMeshTriangles(vector<vector<int>> &faceTris)
	{
	...
	ZSPACE_INLINE void zFnMesh::getMeshFaceVolumes(vector<vector<int>> &faceTris, vector<zVector> &fCenters, vector<double> &faceVolumes, bool absoluteVolumes)
	{
	...
	ZSPACE_INLINE void zFnMesh::getPrincipalCurvatures(vector<zCurvature> &vertexCurvatures)
	{
		for (zItMeshVertex v(*meshObj); !v.end(); v++)
		{
			int j = v.getId();
	...
	ZSPACE_INLINE void zFnMesh::getGaussianCurvature(vector<double> &vertexCurvatures)
	{
	...
	ZSPACE_INLINE void zFnMesh::getEdgeDihedralAngles(vector<double> &dihedralAngles)
	{
		vector<double> out;
	...
	ZSPACE_INLINE double zFnMesh::getHalfEdgeLengths(vector<double> &halfEdgeLengths)
	{
		double total = 0.0;
	...
	ZSPACE_INLINE double zFnMesh::getEdgeLengths(vector<double> &edgeLengths)
	{
		double total = 0.0;
	...
	ZSPACE_INLINE double zFnMesh::getVertexAreas(vector<zVector> &faceCenters, vector<zVector> &edgeCenters, vector<double> &vertexAreas)
	{
		vector<double> out;
	...
	ZSPACE_INLINE double zFnMesh::getPlanarFaceAreas(vector<double> &faceAreas)
	{
	...
	ZSPACE_INLINE void zFnMesh::getPolygonData(vector<int>(&polyConnects), vector<int>(&polyCounts))
	{
		polyConnects.clear();
		polyCounts.clear();
	...
	ZSPACE_INLINE void zFnMesh::getEdgeData(vector<int> &edgeConnects)
	{
		edgeConnects.clear();
	...
	ZSPACE_INLINE void zFnMesh::setScale(double3 &scale)
	{
	...
	ZSPACE_INLINE void zFnMesh::setRotation(double3 &rotation, bool appendRotations)
	{
