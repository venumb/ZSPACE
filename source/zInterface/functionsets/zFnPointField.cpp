...
namespace zSpace
{
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::create(zVector _minBB, zVector _maxBB, int _n_X, int _n_Y, int _n_Z, int _NR)
	{
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zVector>::create(zVector _minBB, zVector _maxBB, int _n_X, int _n_Y, int _n_Z, int _NR)
	{
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::create(double _unit_X, double _unit_Y, double _unit_Z, int _n_X, int _n_Y, int _n_Z, zVector _minBB, int _NR)
	{
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zVector>::create(double _unit_X, double _unit_Y, double _unit_Z, int _n_X, int _n_Y, int _n_Z, zVector _minBB, int _NR)
	{
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::getNeighbour_Contained(zVector &pos, vector<int> &containedNeighbour)
	{

	}

	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::getNeighbourPosition_Contained(zVector &pos, vector<zVector> &containedNeighbour)
	{
	...
	template<typename T>
	ZSPACE_INLINE void zFnPointField<T>::getBoundingBox(zVector &_minBB, zVector &_maxBB)
	{
	...
	template<>
	ZSPACE_INLINE bool zFnPointField<zScalar>::getFieldValue(zVector &samplePos, zFieldValueType type, zScalar& fieldValue)
	{
	...
	template<typename T>
	ZSPACE_INLINE void zFnPointField<T>::setBoundingBox(zVector &_minBB, zVector &_maxBB)
	{
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::setFieldValues(vector<zScalar> &fValues)
	{
	...
	template<typename T>
	ZSPACE_INLINE void zFnPointField<T>::getFieldValuesAsVertexDistance_IDW(vector<T> &fieldValues, vector<zVector> &inPositions, T value, double influence, double power, bool normalise)
	{
	...
	template<typename T>
	ZSPACE_INLINE void zFnPointField<T>::getFieldValuesAsVertexDistance_IDW(vector<T> &fieldValues, vector<zVector> &inPositions, vector<T> &values, vector<double>& influences, double power, bool normalise)
	{
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::getScalarsAsVertexDistance(vector<double> &scalars, zObjPointCloud &inPointsObj, bool normalise)
	{
		scalars.clear();
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::getScalarsAsVertexDistance(vector<double> &scalars, zObjMesh &inMeshObj, double a, double b, bool normalise)
	{
		scalars.clear();
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::getScalarsAsVertexDistance(vector<double> &scalars, zObjGraph &inGraphObj, double a, double b, bool normalise)
	{
		scalars.clear();
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::getScalarsAsEdgeDistance(vector<double> &scalars, zObjMesh &inMeshObj, double a, double b, bool normalise)
	{
		scalars.clear();
		zFnMesh inFnMesh(inMeshObj);
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::getScalarsAsEdgeDistance(vector<double> &scalars, zObjGraph &inGraphObj, double a, double b, bool normalise )
	{
		scalars.clear();
		zFnGraph inFnGraph(inGraphObj);
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::normliseValues(vector<zScalar> &fieldValues)
	{
		zDomainDouble d;
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::computePositionsInFieldIndex(vector<zVector> &positions, vector<vector<zVector>> &fieldIndexPositions)
	{
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zVector>::computePositionsInFieldIndex(vector<zVector> &positions, vector<vector<zVector>> &fieldIndexPositions)
	{
		for (int i = 0; i < numFieldValues(); i++)
		{
			vector<zVector> temp;
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::computePositionIndicesInFieldIndex(vector<zVector> &positions, vector<vector<int>> &fieldIndexPositionIndicies)
	{
		for (int i = 0; i < numFieldValues(); i++)
		{
			vector<int> temp;
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zVector>::computePositionIndicesInFieldIndex(vector<zVector> &positions, vector<vector<int>> &fieldIndexPositionIndicies)
	{
		for (int i = 0; i < numFieldValues(); i++)
		{
			vector<int> temp;
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::boolean_union(vector<zScalar>& scalars0, vector<zScalar>& scalars1, vector<zScalar>& scalarsResult, bool normalise)
	{
		vector<double> out;
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::boolean_subtract(vector<zScalar>& fieldValues_A, vector<zScalar>& fieldValues_B, vector<zScalar>& fieldValues_Result, bool normalise)
	{
		vector<double> out;
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::boolean_intersect(vector<zScalar>& fieldValues_A, vector<zScalar>& fieldValues_B, vector<zScalar>& fieldValues_Result, bool normalise)
	{
		vector<double> out;
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::boolean_difference(vector<zScalar>& fieldValues_A, vector<zScalar>& fieldValues_B, vector<zScalar>& fieldValues_Result, bool normalise)
	{
	...
	template<>
	ZSPACE_INLINE void zFnPointField<zScalar>::boolean_clipwithPlane(vector<zScalar>& scalars, zMatrixd& clipPlane)
	{
		int i = 0;
