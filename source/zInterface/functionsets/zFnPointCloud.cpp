...
namespace zSpace
{
	...
	ZSPACE_INLINE void zFnPointCloud::create(vector<zVector>(&_positions))
	{
	...
	ZSPACE_INLINE void zFnPointCloud::addPosition(zVector &_position)
	{
		pointsObj->pCloud.addVertex(_position);
	}

	ZSPACE_INLINE void zFnPointCloud::addPositions(vector<zVector> &_positions)
	{
	...
	ZSPACE_INLINE void zFnPointCloud::setVertexColors(vector<zColor>& col)
	{
	...
	ZSPACE_INLINE void zFnPointCloud::getVertexPositions(vector<zVector>& pos)
	{
		pos = pointsObj->pCloud.vertexPositions;
	}

	ZSPACE_INLINE zVector* zFnPointCloud::getRawVertexPositions()
	{
	...
	ZSPACE_INLINE void zFnPointCloud::getVertexColors(vector<zColor>& col)
	{
	...
	ZSPACE_INLINE void zFnPointCloud::setScale(double3 &scale)
	{
	...
	ZSPACE_INLINE void zFnPointCloud::setRotation(double3 &rotation, bool appendRotations)
	{
