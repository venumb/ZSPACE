...
namespace zSpace
{
	...
	ZSPACE_INLINE void zFnParticle::create(zVector &_p, bool _fixed , double _m , zVector _v , zVector _f )
	{
	...
	ZSPACE_INLINE zVector zFnParticle::getPosition()
	{
		return *particleObj->particle.s.p;
	}

	ZSPACE_INLINE zVector* zFnParticle::getRawPosition()
	{
		return particleObj->particle.s.p;
	}
	...
	ZSPACE_INLINE void zFnParticle::setScale(double3 &scale)
	{
	...
	ZSPACE_INLINE void zFnParticle::setRotation(double3 &rotation, bool appendRotations)
	{
