...
namespace zSpace
{
	...
	ZSPACE_INLINE void zFnGraph::create(vector<zVector>(&_positions), vector<int>(&edgeConnects), bool staticGraph)
	{
	...
	ZSPACE_INLINE void zFnGraph::create(vector<zVector>(&_positions), vector<int>(&edgeConnects), zVector &graphNormal, bool staticGraph)
	{
	...
	ZSPACE_INLINE bool zFnGraph::vertexExists(zVector pos, int &outVertexId, int precisionfactor)
	{
	...
	ZSPACE_INLINE void zFnGraph::setVertexPositions(vector<zVector>& pos)
	{
	...
	ZSPACE_INLINE void zFnGraph::setVertexColors(vector<zColor>& col, bool setEdgeColor)
	{
	...
	ZSPACE_INLINE void zFnGraph::setEdgeColors(vector<zColor>& col, bool setVertexColor)
	{
	...
	ZSPACE_INLINE void zFnGraph::setEdgeWeights(vector<double>& wt)
	{
	...
	ZSPACE_INLINE void zFnGraph::getVertexPositions(vector<zVector>& pos)
	{
		pos = graphObj->graph.vertexPositions;
	}

	ZSPACE_INLINE zVector* zFnGraph::getRawVertexPositions()
	{
	...
	ZSPACE_INLINE void zFnGraph::getVertexColors(vector<zColor>& col)
	{
	...
	ZSPACE_INLINE void zFnGraph::getEdgeColors(vector<zColor>& col)
	{
	...
	ZSPACE_INLINE zVector zFnGraph::getCenter()
	{
		zVector out;
	...
	ZSPACE_INLINE void zFnGraph::getCenters(zHEData type, vector<zVector> &centers)
	{
		// graph Edge 
	...
	ZSPACE_INLINE double zFnGraph::getHalfEdgeLengths(vector<double> &halfEdgeLengths)
	{
		double total = 0.0;
	...
	ZSPACE_INLINE double zFnGraph::getEdgeLengths(vector<double> &edgeLengths)
	{
		double total = 0.0;
	...
	ZSPACE_INLINE void zFnGraph::getEdgeData(vector<int> &edgeConnects)
	{
		edgeConnects.clear();
	...
	ZSPACE_INLINE void zFnGraph::setScale(double3 &scale)
	{
	...
	ZSPACE_INLINE void zFnGraph::setRotation(double3 &rotation, bool appendRotations)
	{
