...
namespace zSpace
{
	...
	ZSPACE_INLINE void zObjMesh::setShowDihedralEdges(bool _showDihedralEdges, vector<double> &_angles, double _threshold)
	{
	...
	ZSPACE_INLINE void zObjMesh::getBounds(zVector &minBB, zVector &maxBB)
	{
	...
	ZSPACE_INLINE void zObjMesh::appendToBuffer(vector<double> edge_dihedralAngles, bool DihedralEdges, double angleThreshold)
	{
