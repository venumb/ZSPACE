...
namespace zSpace
{
	...
	ZSPACE_INLINE void zMesh::create(vector<zVector>(&_positions), vector<int>(&polyCounts), vector<int>(&polyConnects))
	{
		//clear containers
		clear();
	...
	ZSPACE_INLINE int zMesh::computeNumEdges(vector<int>(&polyCounts), vector<int>(&polyConnects))
	{
	...
	ZSPACE_INLINE void zMesh::setStaticEdgeVertices(vector<vector<int>> &_edgeVertices)
	{
	...
	ZSPACE_INLINE bool zMesh::addPolygon(vector<int> &fVertices)
	{
		// add null polygon
		bool out = addPolygon();
	...
	ZSPACE_INLINE void zMesh::getFaceEdges(int index, vector<int> &edgeIndicies)
	{
	...
	ZSPACE_INLINE void zMesh::getFaceVertices(int index, vector<int> &vertexIndicies)
	{
	...
	ZSPACE_INLINE void zMesh::setStaticFaceVertices(vector<vector<int>> &_faceVertices)
	{
