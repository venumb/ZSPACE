...
namespace zSpace
{
	...
	ZSPACE_INLINE void zUtilsDisplay::drawPoint(zVector &pos, const zColor &col, const double &wt)
	{
	...
	ZSPACE_INLINE void zUtilsDisplay::drawPoints(zVector *pos, zColor *col, double *wt, int size)
	{
	...
	ZSPACE_INLINE void zUtilsDisplay::drawLine(zVector &p0, zVector &p1, const zColor &col , const double &wt)
	{
		glColor3f(col.r, col.g, col.b);
		glLineWidth(wt);
	...
	ZSPACE_INLINE void zUtilsDisplay::drawPolygon(vector<zVector> &pos, const zColor &col)
	{
		glColor3f(col.r, col.g, col.b);
	...
	ZSPACE_INLINE void zUtilsDisplay::drawCircle(zVector &c0, vector<zVector> &circlePts, bool dispLines, const zColor &col, const double &wt)
	{
	...
	ZSPACE_INLINE void zUtilsDisplay::drawEdges(vector<zEdgeHandle> &eHandles, vector<vector<int>> &edgeVerts, zVector *pos, zColor *col, double *wt)
	{
	...
	ZSPACE_INLINE void zUtilsDisplay::drawFaces(vector<zFaceHandle> &fHandles, vector<vector<int>> &faceVerts, zVector *pos, zColor *col)
	{
