...
namespace zSpace
{
	...
	ZSPACE_INLINE bool zDatabase::sqlCommand(vector<string> &sqlStatment, zSQLCommand sqlCommandType, bool displayError, vector<string> &outStatment, bool colType)
	{
		outStatment.clear();
	...
	ZSPACE_INLINE void zDatabase::tableCreate(vector<string> &sqlStatment, string &tableName, vector<string> &columnNames, vector<string> &columnTypes, bool checkPrimaryKey, vector<string> &primarykey)
	{
	...
	ZSPACE_INLINE void zDatabase::tableInsert(vector<string> &sqlStatment, string &tableName, vector<string>& columnNames, vector<string> &values)
	{
