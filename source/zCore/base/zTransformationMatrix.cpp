...
namespace zSpace
{
	...
	ZSPACE_INLINE void zTransformationMatrix::setRotation(double3 &_rotation, bool addValues)
	{
		if (addValues)
		{
	...
	ZSPACE_INLINE void zTransformationMatrix::setScale(double3 &_scale)
	{
		scale[0] = _scale[0];
	...
	ZSPACE_INLINE void zTransformationMatrix::setTranslation(double3 &_translation, bool addValues)
	{
		if (addValues)
		{
	...
	ZSPACE_INLINE void zTransformationMatrix::setPivot(double3 &_pivot)
	{
		pivot[0] = _pivot[0];
		pivot[1] = _pivot[1];
		pivot[2] = _pivot[2];
	...
	ZSPACE_INLINE void zTransformationMatrix::getRotation(double3 &_rotation)
	{
	...
	ZSPACE_INLINE void zTransformationMatrix::getScale(double3 &_scale)
	{
		_scale[0] = scale[0];
