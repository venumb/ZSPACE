...
namespace zSpace
{
	...
	*/
	...
	public:
		...
		*	\since version 0.0.1
		*/
		void getVariableFaceOffset(zObjMesh &out, bool keepExistingFaces = true, bool assignColor = true, double minVal = 0.01, double maxVal = 0.99, bool useVertexColor = false);
		...
		*	\since version 0.0.1
		*/
		void getVariableBoundaryOffset(zObjMesh &out, bool keepExistingFaces = true, bool assignColor = true, double minVal = 0.01, double maxVal = 0.99);
		...
		*	\since version 0.0.1
		*/
		void getVariableFaceThicknessExtrude(zObjMesh &out, bool assignColor, double minVal, double maxVal);
