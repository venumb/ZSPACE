#include <headers/zCudaToolsets/vizscan/zTsVizScan.h>

namespace zSpace
{
	//---- CONSTRUCTOR

	ZSPACE_INLINE zTsVizScan::zTsVizScan() {}
	...
	ZSPACE_INLINE void zTsVizScan::setNormals(const float* _normals, int _numNormals, bool EPWread)
	{
	...
	ZSPACE_INLINE void zTsVizScan::setDomain_Colors(zDomainColor& _dColor)
	{
		dColor = _dColor;
	}
	...
	ZSPACE_INLINE int zTsVizScan::numNormals()
	{
		return numNorms;
	}

	ZSPACE_INLINE int zTsVizScan::numSunVecs()
	{
		return MAX_SUNVECS_HOUR;
	}


	ZSPACE_INLINE float* zTsVizScan::getRawNormals()
	{
		return normals;
	}

	ZSPACE_INLINE float* zTsVizScan::getRawColors()
	{
		return colors;
	}

	ZSPACE_INLINE float* zTsVizScan::getRawNormals_SunVectors()
	{
		return norm_sunvecs;
	}

	ZSPACE_INLINE float* zTsVizScan::getRawSunVectors_hour()
	{
		return sunVecs_hour;
	}

	ZSPACE_INLINE float* zTsVizScan::getRawSunVectors_day()
	{
		return sunVecs_days;
	}

	ZSPACE_INLINE float* zTsVizScan::getRawCompassPts()
	{
		return compassPts;
	}

	ZSPACE_INLINE float* zTsVizScan::getRawEPWRadiation()
	{
		return epwData_radiation;
	}

	ZSPACE_INLINE float* zTsVizScan::getRawCummulativeRadiation()
	{
		return cummulativeRadiation;
	}

	ZSPACE_INLINE zVector zTsVizScan::getSunPosition(zDate& date)
	{
	...
	ZSPACE_INLINE zDomainDate zTsVizScan::getSunRise_SunSet(zDate& date)
	{
		zDomainDate out;
	...
	ZSPACE_INLINE zDomainDate zTsVizScan::getDomain_Dates()
	{
		return dDate;
	}

	ZSPACE_INLINE zDomainColor zTsVizScan::getDomain_Colors()
	{
		return dColor;
	}

	ZSPACE_INLINE zLocation zTsVizScan::getLocation()
	{
		return location;
	}
	...
	ZSPACE_INLINE void zTsVizScan::computeCummulativeRadiation()
	{
	...
	ZSPACE_INLINE void zTsVizScan::computeSunVectors_Year()
	{
		computeSunVectors_Hour();
		computeSunVectors_Day();
	}

	ZSPACE_INLINE void zTsVizScan::computeCompass()
	{
	...
	ZSPACE_INLINE void zTsVizScan::setMemory()
	{
	...
	ZSPACE_INLINE void zTsVizScan::computeSunVectors_Hour()
	{
		zDate min = dDate.min;
		min.tm_mon = 1;
		min.tm_mday = 1;
	...
	ZSPACE_INLINE void zTsVizScan::computeSunVectors_Day()
	{
