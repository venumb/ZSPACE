...
namespace zSpace
{
	...
	*/
	...
	public:
		...
		*	\since version 0.0.2
		*/
		void create(double _unit_X, double _unit_Y, double _unit_Z, int _n_X, int _n_Y, int _n_Z, zVector _minBB = zVector(), int _NR = 1);
		...
		*	\since version 0.0.2
		*/
		void boolean_difference(vector<zScalar>& fieldValues_A, vector<zScalar>& fieldValues_B, vector<zScalar>& fieldValues_Result, bool normalise = false);
