...
namespace zSpace
{
	...
	*/	
	...
	public:
		...
		*	\since version 0.0.2
		*/
		void getScalarsAsVertexDistance(vector<zScalar> &scalars, vector<zVector> &inPositions, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void getScalarsAsVertexDistance(vector<zScalar> &scalars, vector<zVector> &inPositions, double a, double b, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void getScalarsAsVertexDistance(vector<zScalar> &scalars, zObjPointCloud &inPointsObj, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void getScalarsAsVertexDistance(vector<zScalar> &scalars, zObjPointCloud &inPointsObj, double a, double b, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void getScalarsAsVertexDistance(vector<zScalar> &scalars, zObjMesh &inMeshObj, double a, double b, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void getScalarsAsVertexDistance(vector<zScalar> &scalars, zObjGraph &inGraphObj, double a, double b, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void getScalarsAsEdgeDistance(vector<zScalar> &scalars, zObjMesh &inMeshObj, double a, double b, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void getScalarsAsEdgeDistance(vector<zScalar> &scalars, zObjGraph &inGraphObj, double a, double b, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void getScalars_Circle(vector<zScalar> &scalars, zVector &cen, float r, double annularVal = 0, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void getScalars_Line(vector<zScalar> &scalars, zVector &v0, zVector &v1, double annularVal = 0, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void getScalars_Square(vector<zScalar> &scalars, zVector &dimensions, double annularVal = 0, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void getScalars_Trapezoid(vector<zScalar> &scalars, double r1, double r2, double he, double annularVal = 0, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		bool checkPositionBounds(zVector &pos, int &index);
		...
		*	\since version 0.0.2
		*/
		void boolean_union(vector<zScalar>& scalars0, vector<zScalar>& scalars1, vector<zScalar>& scalarsResult, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void boolean_subtract(vector<zScalar>& fieldValues_A, vector<zScalar>& fieldValues_B, vector<zScalar>& fieldValues_Result, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void boolean_intersect(vector<zScalar>& fieldValues_A, vector<zScalar>& fieldValues_B, vector<zScalar>& fieldValues_Result, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void boolean_difference(vector<zScalar>& fieldValues_A, vector<zScalar>& fieldValues_B, vector<zScalar>& fieldValues_Result, bool normalise = true);
		...
		*	\since version 0.0.2
		*/
		void boolean_clipwithPlane(vector<zScalar>& scalars, zMatrixd& clipPlane);
	...
	protected:
		...
		*	\since version 0.0.2
		*/
		void getIsolinePoly(zItMeshFace& f , vector<zVector> &positions, vector<int> &polyConnects, vector<int> &polyCounts, unordered_map <string, int> &positionVertex, double &threshold, bool invertMesh);
		...
		*	\since version 0.0.2
		*/
		void getIsobandPoly(zItMeshFace& f, vector<zVector> &positions, vector<int> &polyConnects, vector<int> &polyCounts, unordered_map <string, int> &positionVertex, double &thresholdLow, double &thresholdHigh);
