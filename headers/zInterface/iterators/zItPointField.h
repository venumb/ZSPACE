...
namespace zSpace
{
	...
	*/
	...
	public:
		...
		*	\since version 0.0.2
		*/
		void getNeighbour_Ring(int numRings, vector<zItPointScalarField> &ringNeighbours);
		...
		*	\since version 0.0.2
		*/
		void getNeighbour_Ring(int numRings, vector<int> &ringNeighbours);
		...
		*	\since version 0.0.2
		*/
		void getNeighbour_Adjacents(vector<zItPointScalarField> &adjacentNeighbours);
		...
		*	\since version 0.0.2
		*/
		void getNeighbour_Adjacents(vector<int> &adjacentNeighbours);
	...
	*/
	...
	public:
		...
		*	\since version 0.0.2
		*/
		void getNeighbour_Ring(int numRings, vector<zItPointVectorField> &ringNeighbours);
		...
		*	\since version 0.0.2
		*/
		void getNeighbour_Adjacents(vector<zItPointVectorField> &adjacentNeighbours);
