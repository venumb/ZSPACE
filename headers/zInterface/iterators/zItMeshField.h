...
namespace zSpace
{
	...
	*/
	...
	public:
		...
		*	\since version 0.0.2
		*/
		void getNeighbour_Ring(int numRings, vector<zItMeshScalarField> &ringNeighbours);
		...
		*	\since version 0.0.2
		*/
		void getNeighbour_Adjacents(vector<zItMeshScalarField> &adjacentNeighbours);
	...
	*/
	...
	public:
		...
		*	\since version 0.0.2
		*/
		void getNeighbour_Ring(int numRings, vector<zItMeshVectorField> &ringNeighbours);
		...
		*	\since version 0.0.2
		*/
		void getNeighbour_Adjacents(vector<zItMeshVectorField> &adjacentNeighbours);
