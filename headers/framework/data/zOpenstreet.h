...
#include <headers/functionsets/zFnMesh.h>


#include <headers/functionsets/zFnField2D.h>
...
namespace zSpace
{
	...
	*/
	...
	public:
		...
		*/
		void fieldFromBounds(int _n_X = 100, int _n_Y = 100)
		{
			...
			fieldFn = zFnField2D<double>(scalarfield);

			 fieldFn.getFieldMesh(fieldMesh);
		...
		*/
		void createStreetGraph(zColor edgeCol = zColor(0, 0, 0, 1))
		{
			...
			//zFnGraph tempFn(streetGraph);
			//tempFn.setEdgeColor( edgeCol, true);
			...
			while (!myfile.eof())
			{
				...
				for (int i = 0; i < perlineData.size(); i++)
				{
					...
					do
					{
						...
						int v0;
						bool vExists = coreUtils.vertexExists(positionVertex, p0, v0);
	...
	template <>
	inline void zOpenStreet::updateScalars_fromCSV(string infilename, vector<string> &data)
	{
		data.clear();
	...
	template <>
	inline void zOpenStreet::updateScalars_fromCSV(string infilename, vector<double> &data)
	{
		data.clear();
	...
	template <>
	inline void zOpenStreet::updateScalars_fromCSV(string infilename, vector<float> &data)
	{
		data.clear();
	...
	template <>
	inline void zOpenStreet::updateScalars_fromCSV(string infilename, vector<int> &data)
	{
		data.clear();
	...
	template <>
	inline void zOpenStreet::updateScalars_fromCSV(string infilename, vector<zVector> &dataPositions, vector<string> &data)
	{
		dataPositions.clear();
		data.clear();
	...
	template <>
	inline void zOpenStreet::updateScalars_fromCSV(string infilename, vector<zVector> &dataPositions, vector<double> &data)
	{
		dataPositions.clear();
		data.clear();
	...
	template <>
	inline void zOpenStreet::updateScalars_fromCSV(string infilename, vector<zVector> &dataPositions, vector<float> &data)
	{
		dataPositions.clear();
		data.clear();
	...
	template <>
	inline void zOpenStreet::updateScalars_fromCSV(string infilename, vector<zVector> &dataPositions, vector<int> &data)
	{
		dataPositions.clear();
		data.clear();
